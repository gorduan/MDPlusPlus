  ...
  return (
    <header className="toolbar">
      ...
      <div className="toolbar__section toolbar__section--right">
        ...
        {/* Theme Toggle - Shows both sun and moon to indicate current mode */}
        <button
          className={`toolbar__btn toolbar__btn--theme-toggle ${theme === 'dark' ? 'toolbar__btn--dark' : 'toolbar__btn--light'}`}
          onClick={onToggleTheme}
          title={theme === 'dark' ? t('toolbar.lightMode') : t('toolbar.darkMode')}
        >
          {/* Sun icon - highlighted when light mode */}
          <svg
            className={`toolbar__theme-icon toolbar__theme-icon--sun ${theme === 'light' ? 'toolbar__theme-icon--active' : ''}`}
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
          ...
          {/* Moon icon - highlighted when dark mode */}
          <svg
            className={`toolbar__theme-icon toolbar__theme-icon--moon ${theme === 'dark' ? 'toolbar__theme-icon--active' : ''}`}
            viewBox="0 0 24 24"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
